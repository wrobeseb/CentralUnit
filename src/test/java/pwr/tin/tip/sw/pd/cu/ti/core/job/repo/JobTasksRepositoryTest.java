...
public class JobTasksRepositoryTest {
	...
	public void synchronizationTest() throws JobTaskNotFoundException, InterruptedException {
		final JobTaskReplaiesRepository jobTasksRepository = new JobTaskReplaiesRepository();
		final JobTask jobTask1 = new JobTask(1, 1, null, null);
		final JobTask jobTask2 = new JobTask(2, 1, null, null);
		final JobTaskReplay jobTaskReplay1 = new JobTaskReplay(1, 1);
		final JobTaskReplay jobTaskReplay2 = new JobTaskReplay(2, 1);

		new Thread(new Runnable() {
			@Override
			public void run() {
				try {
					jobTasksRepository.take(jobTask1);
					jobTasksRepository.take(jobTask2);
				} 
